...
# مشغل موسيقى البيانو والتشيلو الخاصة بك (music.mp3)
st.markdown("🎹 **موسيقى البيانو والتشيلو الخاصة بك (للمساعدة في التركيز أثناء العمل):**")
if os.path.exists("music.mp3"):
    st.audio("music.mp3", format="audio/mp3")
else:
    st.warning("الرجاء التأكد من رفع ملف الموسيقى الخاص بك باسم music.mp3 في نفس مجلد المشروع على جيت هب.")
